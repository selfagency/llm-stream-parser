...
describe('computeReplicaScore — quota headroom', () => {
  ...
  it('headroom bonus stacks with local bonus', () => {
    ...
    // local: 100 × 1 = 100, headroom: 100 × 0.15 = 15, total = 115
    expect(localScore).toBeCloseTo(115, 5);
  });
  ...
  it('headroom bonus can offset latency penalty', () => {
    ...
    // high: 100×0.15 - 500×0.01 = 15 - 5 = 10
    // low: 0×0.15 - 0 = 0
    expect(highHeadroomHighLatency).toBeCloseTo(10, 5);
    expect(lowHeadroomLowLatency).toBeCloseTo(0, 5);
